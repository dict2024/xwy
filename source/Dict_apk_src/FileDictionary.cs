...
{    
	public class FileDictionary 
	{
		...
		// Methods
		public FileDictionary(AssetManager assets, string folder, int resultSize)
		{
			this.assets = assets;
        ...
        {
            StreamReader reader = new StreamReader(this.assets.Open(folder + "/binary.ini"), Encoding.UTF8);
            string input;
            ...
            reader = new StreamReader(this.assets.Open(folder + "/count.ini"), System.Text.Encoding.UTF8);
		...
		public string getData(KeyNode node)
		{
			...
			string input;
			string[] array;
			StreamReader reader = new StreamReader(this.assets.Open(node.dictionary + "/data" + fileID + ".ini"), Encoding.UTF8);
			while ((input = reader.ReadLine()) != null)
			{
				count++;
				if (count == lineID)
        ...
        private Stream getDataFileName(int id)
		{
            return this.assets.Open(this.folder + "/data" + id + ".ini");
		}
        ...
        private Stream getSortFileName(int id)
		{
			return this.assets.Open(this.folder + "/sort" + id + ".ini");
		}
